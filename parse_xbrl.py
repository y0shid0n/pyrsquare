...
for file in file_list:
    ...
    # 値の列と単位の列が逆、単位自体は分かれていなかったので個別対応
        ...
        df["前連結会計年度(平成30年3月31日)_unit"] = df["前連結会計年度(平成30年3月31日)"].apply(lambda x: myfunc.get_unit(x))
        df["当連結会計年度(平成31年3月31日)_unit"] = df["当連結会計年度(平成31年3月31日)"].apply(lambda x: myfunc.get_unit(x))
    elif ecode == "E05017":
        df.columns = ['account', '前連結会計年度(2018年3月31日)_unit', '前連結会計年度(2018年3月31日)', ''
            , '当連結会計年度(2019年3月31日)_unit', '当連結会計年度(2019年3月31日)']
        df["前連結会計年度(2018年3月31日)_unit"] = df["前連結会計年度(2018年3月31日)"].apply(lambda x: myfunc.get_unit(x))
        df["当連結会計年度(2019年3月31日)_unit"] = df["当連結会計年度(2019年3月31日)"].apply(lambda x: myfunc.get_unit(x))
    elif ecode == "E01859":
        df.columns = ['account', '', '前連結会計年度(2018年3月31日)_unit', '前連結会計年度(2018年3月31日)', ''
            , '', '当連結会計年度(2019年3月31日)_unit', '当連結会計年度(2019年3月31日)', '']
